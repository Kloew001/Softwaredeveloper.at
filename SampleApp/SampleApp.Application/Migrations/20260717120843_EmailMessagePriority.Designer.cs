...
namespace SampleApp.Application.Migrations
{
    ...
    [Migration("20260717120843_EmailMessagePriority")]
    partial class EmailMessagePriority
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SampleApp.Application.Sections.CarSection.Car", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SampleApp.Application.Sections.PersonSection.Address", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SampleApp.Application.Sections.PersonSection.PersonAudit", b =>
                {
                    ...
                    b.Property<DateTime>("AuditValidFrom")
                        .HasColumnType("TIMESTAMP WITHOUT TIME ZONE");

                    b.Property<DateTime?>("AuditValidTo")
                        .HasColumnType("TIMESTAMP WITHOUT TIME ZONE");
            ...
            modelBuilder.Entity("SoftwaredeveloperDotAt.Infrastructure.Core.Sections.EMailMessage.EmailMessage", b =>
                {
                    ...
                    b.HasIndex("Status", "Priority", "SendAt");
            ...
            modelBuilder.Entity("SampleApp.Application.Sections.CarSection.CombustionCar", b =>
                {
                    b.HasBaseType("SampleApp.Application.Sections.CarSection.Car");
                    ...
                    b.HasDiscriminator().HasValue("CombustionCar");
                });

            modelBuilder.Entity("SampleApp.Application.Sections.CarSection.ElectricCar", b =>
                {
                    b.HasBaseType("SampleApp.Application.Sections.CarSection.Car");
                    ...
                    b.Property<int>("ChargeTimeMinutes")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SampleApp.Application.Sections.CarSection.ClassicCar", b =>
                {
                    b.HasBaseType("SampleApp.Application.Sections.CarSection.CombustionCar");

                    b.Property<bool>("IsHistoricRegistration")
                        .HasColumnType("boolean");

                    b.Property<DateTime?>("LastRestorationDate")
                        .HasColumnType("timestamp with time zone");

                    b.ToTable("Car");

                    b.HasDiscriminator().HasValue("ClassicCar");
                });

            modelBuilder.Entity("SampleApp.Application.Sections.CarSection.HybridCar", b =>
                {
                    b.HasBaseType("SampleApp.Application.Sections.CarSection.ElectricCar");

                    b.Property<double>("CombustionEngineDisplacementLiters")
                        .HasColumnType("double precision");

                    b.Property<string>("HybridType")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("SampleApp.Application.Sections.PersonSection.Address", b =>
                {
                    b.HasOne("SampleApp.Application.Sections.PersonSection.Person", "Person")
                        .WithMany("Addresses")
